...
2. **(optional) Audit's Tier 4 reference-gallery cleanups.**
   ...
   - TimezoneSelect datasets diverge between galleries (analyst auto-highlights first row, Blueprint shows none); align rows for a clean comparison signal.

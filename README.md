...
> This library is an experiment in agent-mediated code built by long-horizon autonomous agent loops, with no human reading the code. The backstory ([The experiment](#the-experiment)); what came out is the library below.
